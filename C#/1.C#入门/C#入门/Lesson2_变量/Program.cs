...
namespace Lesson2_变量
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //1.有符号的整形变量 是能存储 一定范围 正负数包括的变量类型
            // sbyte -128~127
            sbyte sb = 1;
            //潜在知识点 通过+来进行拼接打印
            ...
            //3.浮点数(小数)
            //float 存储7/8位有效数字 根据译器不同 有效数字也可能不一样 四舍五入
            //有效数字 是从左到右从非@数开始算有效数字的
            ...
            int i2 = 1;
            float f2 = 3.2f; string str2 = "123";
            bool bo3 = true;
            //多个同类型变量申明
            //固定写法
            // 变量类型 变量名 = 初始值,变量名 = 初始值,变量名  初始值...;
            int al = 1, b1 = 2, cl = 3, d1 = 4;
