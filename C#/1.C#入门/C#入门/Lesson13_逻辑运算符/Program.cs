...
namespace Lesson13_逻辑运算符
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //boo1相关的类型 boo1变量 条件运算符
            //逻运算符优先级 低于 条件运算符 算术运算
            // true && true
            result = 3 > 1 && 1 < 2;
            Console.WriteLine(result);
