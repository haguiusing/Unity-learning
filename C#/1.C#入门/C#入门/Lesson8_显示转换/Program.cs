...
namespace Lesson8_显示转换
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(long.Parse("111213232"));
            ...
            //语法:Convert.Tom目标类型(变量或常量)
            //注意:填写的变量或常量必须正确 否则出错

            //转字符串 如果是吧字符串转对应类型 那字符串一定要合法合规
            //精度更准确
            ...
            //特殊类型转换
            //bool类型也可以转成 数值类型 true对应1 false对应0
            ...
            string str5 = Convert.ToString(123456);
