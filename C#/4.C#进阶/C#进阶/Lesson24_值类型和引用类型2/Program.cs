namespace Lesson24_值类型和引用类型2
{
    class Test()
    {
        ...
        TestStrict testStrict1 = new TestStrict();
        ...
        static void Main(string[] args)
         {
            ...
            #region 知识点四：结构体中的值和引用
            //结构体本身是值类型
            //前提: 该结构体没有做为其它类的成员
            //在结构体中的值，栈中存储值具体的内容
            //在结构体中的引用，栈中存储地址，堆中存储引用具体的内容

            //引用类型始终存储在堆中
            //真正通过结构体使用其中引用类型时只是顺藤摸瓜

            TestStrict testStrict = new TestStrict();
